...
final class Constants {
     ...
     */
    static final Contract<Dispatcher> DISPATCHER = Contract.create("Dispatcher contract");
    
    /**
     * Set to true when program is quitting
     */
    static final Contract<CountDownLatch> IS_QUITTING = Contract.create("Quitting contract");
    
    /**
     * The health the program
     */
    static final Contract<AtomicReference<String>> HEALTH = Contract.create("Health contract");
